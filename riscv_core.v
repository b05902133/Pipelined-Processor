...
module riscv_core(
    ...
    */
    ...
    function logic stall
        ...
        use_rs1_ID = use_rs1(dec_out[5:3], inst_p0);
    ...
    function logic switch_condition
        (input logic [14:0] dec_out_I0, dec_out_I1, 
         input logic [31:0] inst_I0_p0, inst_I1_p0);

        logic alu_instruction_I0, alu_instruction_I1;
        logic mem_instruction_I0, mem_instruction_I1;
         
        logic [2:0] inst_type_I0, inst_type_I1;
        logic reg_file_we_I0;

        logic [4:0] rs1_field_I1, rs2_field_I1, rd_field_I0;
        logic use_rs1_I1, use_rs2_I1;

        inst_type_I0 = dec_out_I0[5:3];
        inst_type_I1 = dec_out_I1[5:3];

        rs1_field_I1 = rs1_field(inst_I1_p0);
        rs2_field_I1 = rs2_field(inst_I1_p0);
        rd_field_I0 = rd_field(inst_I0_p0);
    
        use_rs1_I1 = use_rs1(inst_type_I1, inst_I1_p0);
        use_rs2_I1 = use_rs2(inst_type_I1, inst_I1_p0);

        reg_file_we_I0 = dec_out_I0[2];

        if (inst_type_I0 == `I_TYPE || inst_type_I0 == `R_TYPE)
          alu_instruction_I0 = 1'b1;
        if (inst_type_I1 == `I_TYPE || inst_type_I1 == `R_TYPE)
          alu_instruction_I1 = 1'b1;
        if (inst_type_I0 == `L_TYPE || inst_type_I0 == `S_TYPE)
          mem_instruction_I0 = 1'b1;
        if (inst_type_I1 == `L_TYPE || inst_type_I1 == `S_TYPE)
          mem_instruction_I0 = 1'b1;

        if ((alu_instruction_I0 && alu_instruction_I1) ||
            (alu_instruction_I0 && mem_instruction_I1) ||
            (mem_instruction_I0 && alu_instruction_I1)) begin
            
            if ((rs1_field_I1 == rd_field_I0 && use_rs1_I1 && reg_file_we_I0) ||
                (rs2_field_I1 == rd_field_I0 && use_rs2_I1 && reg_file_we_I0))
                return 1'b1;
            else
                return 1'b0;
    ...
    endfunction: switch_condition
 
    function logic [127:0] switch
        (input logic [127:0] ir_p0); 
        
        return {ir_p0[3], ir_p0[2], 32'b0, ir_p0[1]};

    endfunction: switch 

     function logic [127:0] pass_I0
        (input logic [127:0] ir_p0); 
        
        return {ir_p0[3], ir_p0[2], 32'b0, ir_p0[0]};
    ...
    // This lays down logic for taking in two outputs
    // of the forward_rs1_condition or forward_rs2_condition 
    // functions, in order to decide for a specific instruction
    // (primary or secondary) whether or not their rs1/rs2 data needs 
    // forwarding.
    function logic [2:0] forward_condition
        (input logic [1:0] condition_I1, condition_I0);

        if (condition_I0 < condition_I1) 
            return {condition_I0, 1'b0};
        else 
            return {condition_I1, 1'b1};
         
    endfunction: forward_condition
...
*/
    ...
    assign stall_condition_I0_I0 = stall(ir_switch[0], ir_p1[0],
                                         {dec__sel_I0, inst_type_I0, 
                                          ctrl_we_I0, 
                                          ctrl_Sys_I0, ctrl_RI_I0}, 
                                         decode_out_I0_p1);

    // Assign the stall condition 
    assign stall_condition_I0_I1 = stall(ir_switch[0], ir_p1[1],
                                         {dec__sel_I0, inst_type_I0, 
                                          ctrl_we_I0, 
                                          ctrl_Sys_I0, ctrl_RI_I0}, 
                                         decode_out_I1_p1);
    ...
    // Assign the stall condition 
    assign stall_condition_I1_I0 = stall(ir_switch[1], ir_p1[0],
                                         {dec__sel_I1, inst_type_I1, 
                                          ctrl_we_I1, 
                                          ctrl_Sys_I1, ctrl_RI_I1}, 
                                         decode_out_I0_p1);

    // Assign the stall condition 
    assign stall_condition_I1_I1 = stall(ir_switch[1], ir_p1[1],
                                         {dec__sel_I1, inst_type_I1, 
                                          ctrl_we_I1, 
                                          ctrl_Sys_I1, ctrl_RI_I1}, 
                                         decode_out_I1_p1);

    assign stall_I0 = stall_condition_I0_I0 || stall_condition_I0_I1;
    assign stall_I1 = (stall_condition_I1_I0 || 
                       stall_condition_I1_I1 || 
                       switch_primary);
    assign stall = stall_I0 || stall_I1;

    assign switch_primary = switch_condition ({dec__sel_I0, inst_type_I0, 
                                               ctrl_we_I0,
                                               ctrl_Sys_I0, ctrl_RI_I0}, 
                                              {dec__sel_I1, inst_type_I1, 
                                               ctrl_we_I1,
    ...
    register #(1, 0) SwitchPrimaryReg (switch_primary_reg, 
                                     i  switch_primary, clk, 1'b1, rst_b);

    assign ir_switch_primary = switch (ir_p0);
    assign ir_pass_I0 = pass_I0(ir_p0);
    ...
    assign forward_rs1_data_I0_I0 = forward_rs1_condition(ir_switch[0], 
                                                          ir_p1[0], 
                                                          ir_p2[0], 
                                                          ir_p3[0],
                                                          decode_out_I0_p1,
    ...
    // Assign the forward condition to rs1
    assign forward_rs1_data_I0_I1 = forward_rs1_condition(ir_switch[0], 
                                                          ir_p1[1], 
                                                          ir_p2[1], 
                                                          ir_p3[1],
                                                          decode_out_I1_p1,
    ...
    // Assigns forward condition for rs1 of I0
    assign forward_rs1_data_I0 = forward_condition(forward_rs1_data_I0_I1, 
                                                   forward_rs1_data_I0_I0);

    // Assign the forward condition to rs1
    assign forward_rs1_data_I1_I0 = forward_rs1_condition(ir_switch[1], 
                                                          ir_p1[0], 
                                                          ir_p2[0], 
                                                          ir_p3[0],
                                                          decode_out_I0_p1,
    ...
    // Assign the forward condition to rs1
    assign forward_rs1_data_I1_I1 = forward_rs1_condition(ir_switch[1], 
                                                          ir_p1[1], 
                                                          ir_p2[1],   
                                                          ir_p3[1],
                                                          decode_out_I1_p1,
    ...
    // Assigns forward condition for rs1 of I1
    assign forward_rs1_data_I1 = forward_condition(forward_rs1_data_I1_I1, 
                                                   forward_rs1_data_I1_I0);

    // Assign the forward condition to rs2
    assign forward_rs2_data_I0_I0 = forward_rs2_condition(ir_switch[0], 
                                                          ir_p1[0], 
                                                          ir_p2[0], 
                                                          ir_p3[0],
                                                          decode_out_I0_p1,
    ...
    // Assign the forward condition to rs2
    assign forward_rs2_data_I0_I1 = forward_rs2_condition(ir_switch[0], 
                                                          ir_p1[1], 
                                                          ir_p2[1], 
                                                          ir_p3[1],
                                                          decode_out_I1_p1,
    ...
    // Assigns forward condition for rs2 of I0
    assign forward_rs2_data_I0 = forward_condition(forward_rs2_data_I0_I1, 
                                                   forward_rs2_data_I0_I0);

    // Assign the forward condition to rs2
    assign forward_rs2_data_I1_I0 = forward_rs2_condition(ir_switch[1], 
                                                          ir_p1[0], 
                                                          ir_p2[0], 
                                                          ir_p3[0],
                                                          decode_out_I0_p1,
    ...
    // Assign the forward condition to rs2
    assign forward_rs2_data_I1_I1 = forward_rs2_condition(ir_switch[1], 
                                                          ir_p1[1], 
                                                          ir_p2[1], 
                                                          ir_p3[1],
                                                          decode_out_I1_p1,
    ...
    // Assigns forward condition for rs2 of I1
    assign forward_rs2_data_I1 = forward_condition(forward_rs2_data_I1_I1, 
                                                   forward_rs2_data_I1_I0);
    ...
    nextpc_mux NPCMux (.nextpc(nextpc),
                       .btb_out(btb_out),
    ...
    assign pc_en0 = !stall;
    assign pc_plus_four_en0 = !stall; 
    assign pc_plus_eight_en0 = !stall;
    assign ir_en0 = !stall;
    assign btb_en0 = !stall;
    ...
    assign        dcd_op_I0 = opcode_t'(ir_switch[0][6:0]);
    assign        dcd_rs1_I0 = ir_switch[0][19:15];
    assign        dcd_rs2_I0 = ir_switch[0][24:20];
    assign        dcd_rd_I0 = ir_switch[0][11:7];

    // Decode the various function codes for the instruction
    assign        dcd_funct3_I0 = ir_switch[0][14:12];
    assign        dcd_funct7_I0 = ir_switch[0][31:25];
    assign        dcd_funct12_I0 = ir_switch[0][31:20];

    // Decode the opcode, and registers for the instruction
    assign        dcd_op_I1 = opcode_t'(ir_switch[1][6:0]);
    assign        dcd_rs1_I1 = ir_switch[1][19:15];
    assign        dcd_rs2_I1 = ir_switch[1][24:20];
    assign        dcd_rd_I1 = ir_switch[1][11:7];

    // Decode the various function codes for the instruction
    assign        dcd_funct3_I1 = ir_switch[1][14:12];
    assign        dcd_funct7_I1 = ir_switch[1][31:25];
    assign        dcd_funct12_I1 = ir_switch[1][31:20];
    ...
    pipeline_register_mux #(128) IRSwitchMux (ir_switch, 
                                              ir_p0,  
                                              ir_switch_primary, 
                                              switch_primary_reg);

    pipeline_register_mux #(128) IRPassI0Mux (ir_result, 
                                              ir_switch,  
                                              ir_pass_I0, 
                                              switch_primary);

    // Either pass along the pc information, or a bubble
    pipeline_register_mux #(32) PCSwitchMux (pc_switch, 
                                             pc_p0,
                                             pc_plus_four_p0, 
                                             switch_primary_reg); 

    // Either pass along the pc+4 information, or a bubble
    pipeline_register_mux #(32) PC4SwitchMux (pc_plus_four_switch, 
                                              pc_plus_four_p0,
                                              pc_plus_eight_p0, 
                                              switch_primary_reg); 

    // Either pass along the pc+8 information, or a bubble
    pipeline_register_mux #(32) PC8SwitchMux (pc_plus_eight_switch, 
                                              pc_plus_eight_p0,
                                              32'b0, 
                                              switch_primary_reg); 
    ...
    assign decode_out_I0_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign decode_out_I1_bubble_p1 = stall || (mispredict && btb_we);
    assign pc_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign pc_plus_four_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign pc_plus_eight_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign rs1_data_I0_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign rs1_data_I1_bubble_p1 = stall || (mispredict && btb_we);
    assign rs2_data_I0_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign rs2_data_I1_bubble_p1 = stall || (mispredict && btb_we);
    assign ir_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign se_offset_I0_bubble_p1 = stall_I0 || (mispredict && btb_we);
    assign se_offset_I1_bubble_p1 = stall || (mispredict && btb_we);
    assign btb_bubble_p1 = 1'b1;
    ...
    pipeline_register_mux #(32) PC4MuxP1 (pc_plus_four_mux_p1, 
                                          pc_plus_four_switch,
                                          32'b0, 
                                          pc_plus_four_bubble_p1); 

    // Either pass along the pc+8 information, or a bubble
    pipeline_register_mux #(32) PC8MuxP1 (pc_plus_eight_mux_p1, 
                                          pc_plus_eight_switch,
                                          32'b0, 
                                          pc_plus_eight_bubble_p1); 
    ...
    forwarding_mux RS2MuxI1P1 (rs2_data_mux_I1_p1, 
                               ...
                               rd_data_I0, 
                               rd_data_I1, 
                               rs2_data_I1_bubble_p1, 
                               forward_rs2_data_I1, 
                               decode_out_I0_p2[5:3], 
                               decode_out_I1_p2[5:3]);

    // Either pass along the instruction information, or a bubble
    pipeline_register_mux #(128) IRMuxP1 (ir_mux_p1, 
                                          ir_result,
                                          128'b0, 
                                          ir_bubble_p1); 
...
module forwarding_mux
    (output logic [31:0] out, 
     input logic [31:0] data_ID, data_I0_EX, data_I1_EX, 
     input logic [31:0] data_load_MEM, data_alu_I0_MEM, 
     input logic [31:0] data_alu_I1_MEM, data_I0_WB, data_I1_WB,  
     input logic stall, 
     input logic [2:0] forward, 
     input logic [2:0] inst_type_I0_MEM, inst_type_I1_MEM);
    ...
    always_comb begin
        if (stall)
            ...
            case (forward)
                3'b00x: out = data_ID;
                3'b010: out = data_I0_EX;
                3'b011: out = data_I1_EX;
                3'b100: begin
                    if (inst_type_I0_MEM == `L_TYPE)
                        out = data_load_MEM;
                    else
                        out = data_alu_I0_MEM;
                end
                3'b101: begin
                    if (inst_type_I1_MEM == `L_TYPE)
                        out = data_load_MEM;
                    else
                        out = data_alu_I1_MEM;
                end
                3'b110: out = data_I0_WB;
                3'b111: out = data_I1_WB;
            endcase
        end
    end 
